...
Tags: woocommerce, woo, wpc, product, timer, schedule
...
= 4.3.1 =
* Updated: Change user role(s) selector displaying

= 4.3.0 =
* Added: User role(s) selector
...
= 4.2.5 =
* Added: Condition "Variations only" & "Non-variation products"

= 4.2.4 =
* Updated: Used a number field for "Days of being published"
...
= 4.2.1 =
* Added: Two time conditionals "Days of being published are smaller than" & "Days of being published are bigger than"

= 4.2.0 =
* Added: Combined sources
...
= 4.0.5 =
* Added: Filter hook 'woopt_ignore'
...
= 4.0.2 =
* Added: Dutch translation - Thanks to Pascal ten Klooster
* Added: Import/Export for Global Timer
...
= 3.5.8 =
* Added: Even/Odd week conditional
* Added: Run wc_delete_product_transients() when updating the timer

= 3.5.7 =
* Fixed: Minor CSS/JS issues

= 3.5.6 =
* Fixed: Wrong time comparison in "daily before time" and "daily after time"

= 3.5.5 =
* Fixed: Date time picker doesn't work after adding or duplicating an action

= 3.5.4 =
* Added: "Monthly day" conditional
...
= 3.5.1 =
* Added: Save actions button

= 3.5.0 =
* Added: Drag/drop to rearrange actions
* Added: Expand/collapse actions
* Added: Duplicate an action
* Note: Please CLEAR THE CACHE after updating to this version
...
= 3.4.0 =
* Added: Quick edit timer on products list
* Fixed: Export/import products

= 3.3.0 =
* Added: Product Taxonomies for Global Timer

= 3.2.4 =
* Added: Month No. conditional

= 3.2.3 =
* Updated: Compatible with WordPress 5.7.2 & WooCommerce 5.3

= 3.2.2 =
* Updated: Compatible with WordPress 5.7.1 & WooCommerce 5.2.1

= 3.2.1 =
* Updated: Optimized the code

= 3.2.0 =
* Added: Select products or variations in "Apply for" option
...
= 2.1.1 =
* Added: Enable/disable sold individually
...
= 2.0.5 =
* Added: Week No. conditional

= 2.0.4 =
* Fixed: Daily time range, Daily time before & Daily time after

= 2.0.3 =
* Updated: Compatible with WordPress 5.4.2 & WooCommerce 4.2

= 2.0.2 =
* Added: Adjust product listings (set featured or unfeatured)

= 2.0.1 =
* Updated: Compatible with WordPress 5.4 & WooCommerce 4.0.1

= 2.0.0 =
* Added: "Everyday" time conditional
* Fixed: Multiple same actions
...
= 1.3.0 =
* Added: Product timer column
* Updated: Compatible with WordPress 5.3 & WooCommerce 3.8

= 1.2.8 =
* Added: New regular/sale price by percentage

= 1.2.7 =
* Updated: Optimized the code

= 1.2.6 =
* Added: Classes for the current active product

= 1.2.5 =
* Fixed: Purchasable / un-purchasable for variable product
* Updated: Compatible with WooCommerce 3.6.x

= 1.2.4 =
* Added: Weekly on every weekday

= 1.2.3 =
* Updated: Optimized the code

= 1.2.2 =
* Fixed: The variation price

= 1.2.1 =
* Added: 4 new date time conditionals
* Added: List all products was set timer

= 1.2.0 =
* Fixed: Error when WooCommerce is not active

= 1.1.0 =
* Added: Combination of time conditionals
* Added: Multiple actions (Premium)
